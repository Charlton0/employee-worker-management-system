...
class attendancebox implements ActionListener {
    JFrame f = new JFrame(" Attendance Management ");
    JLabel l1;
    JLabel l2;
    JButton b1;
    JButton b2;
    ...
    attendancebox() {
        ...
        this.l1.setIcon(i1);
        this.f.add(this.l1);
        this.b1 = new JButton("Fill Attendance");
        this.b1.setBounds(420, 60, 210, 40);
        this.b1.setFont(new Font("serif", 1, 15));
        this.b1.addActionListener(this);
        this.l1.add(this.b1);
        this.b2 = new JButton("View Attendance");
        this.b2.setBounds(420, 120, 210, 40);
