...
public class pay_slip extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            conn c = new conn();
            ResultSet rs = c.s.executeQuery("select * from employee where emp_id=" + this.c1.getSelectedItem());
            rs.next();
            ...
            int year = d1.getYear();
            this.t1.setText(" ----------------   PAY SLIP FOR THE MONTH OF " + month + " , " + year + "  ------------------------");
            this.t1.append("\n");
            if (rs.next()) {
                ...
                this.t1.append("\n");
                this.t1.append("\n       GROSS SALARY :" + gross + "    \n       NET SALARY : " + net);
                this.t1.append("\n       Tax   :   2.1% of gross " + gross * 2.1 / 100.0);
                this.t1.append("\n -------------------------------------------------");
                this.t1.append("\n");
                this.t1.append("\n");
                this.t1.append("\n");
