...
public class Add_salary extends JFrame implements ActionListener {
    ...
    Add_salary() {
        ...
        this.add(this.c2);
        this.l1 = new JLabel("     HRA (House Rent Allowance)");
        this.t1 = new JTextField(15);
        this.add(this.l1);
        this.add(this.t1);
        this.l3 = new JLabel("     DA (Dearness Allowance)");
        this.t3 = new JTextField(15);
        this.add(this.l3);
        this.add(this.t3);
        this.l4 = new JLabel("     MA (Medical Allowance)");
        this.t4 = new JTextField(15);
        this.add(this.l4);
        this.add(this.t4);
        this.l5 = new JLabel("     PF (Provident Fund)");
